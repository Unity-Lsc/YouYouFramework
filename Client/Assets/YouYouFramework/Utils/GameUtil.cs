...
public class GameUtil
{
    ...
    //    /// 获取资源的路径
    //    /// </summary>
    //    /// <param name="path">这个path是到bundle的路径为止</param>
    //    /// <param name="fileName">这个是bundle里边文件的路径</param>
    //    /// <returns></returns>
    ...
    public static string GetUIResPath(string path)
    {
        ...
        string str = sbr.AppendFormatNoGC("Assets/Download/UI/UIRes/{0}.png", path).ToString();
    ...
    /// <param name="path"></param>
    /// <returns></returns>
    public static string GetRoleAnimationPath(string path)
    {
        StringBuilder sbr = StringHelper.PoolNew();
        string str = sbr.AppendFormatNoGC("Assets/Download/Role/RolePrefab/Player/{0}.anim", path).ToString();
        StringHelper.PoolDel(ref sbr);
        return str;
    }
    ...
    /// <param name="path"></param>
    /// <returns></returns>
    public static float GetPathLen(Vector3[] path)
    {
